---
name: "source-command-verify-production"
description: "Verify Mushroomie production routes, health, MIME, media and PM2 logs after deploy."
---

# source-command-verify-production

Use this skill when the user asks to run the migrated source command `verify-production`.
