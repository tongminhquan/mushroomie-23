    ...
    <div className="min-h-screen bg-theme-page pb-16">
      ...
      <section className="max-w-3xl mx-auto px-4 sm:px-6 pt-12">
        <div className="relative pl-10">
          ...
          {timeline.map((m) => (
            <div data-reveal key={m.year} className="relative mb-8 last:mb-0">
              <span
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 pt-12">
        <div className="grid gap-5 md:grid-cols-2">
          <div data-reveal className="h-full rounded-[24px] border border-theme-border bg-theme-card p-7 shadow-card">
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 pt-14">
        ...
        <div className="grid gap-5 sm:grid-cols-3">
          {values.map((v) => (
            <div data-reveal key={v.title} className="rounded-[24px] border border-theme-border bg-theme-card p-7 text-center shadow-card">
      ...
      {orderedCategories.length > 0 && (
        <section className="max-w-5xl mx-auto px-4 sm:px-6 pt-14">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-7">
            <h2 data-reveal className="font-heading text-2xl md:text-3xl text-theme-primary">Sản phẩm của chúng mình</h2>
