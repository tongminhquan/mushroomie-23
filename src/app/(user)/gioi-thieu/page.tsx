          ...
          <div className="grid grid-cols-1 items-stretch gap-5 sm:grid-cols-2 lg:grid-cols-4">
            <StaggerChildren animation="zoom-in" staggerDelay={100}>
              {orderedCategories.map((prod: Category, idx: number) => {
                ...
                return (
                <Link href={link} key={prod.id ?? idx} className={`${color} flex h-[260px] flex-col rounded-3xl border border-black/5 p-6 transition-transform duration-300 hover:scale-[1.02]`}>
