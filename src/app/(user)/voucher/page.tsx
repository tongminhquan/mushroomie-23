...
export default function VoucherLandingPage() {
  return (
    <div className="min-h-screen bg-theme-page">
      {/* Hero */}
      <section className="relative overflow-hidden bg-theme-section">
        ...
        <section>
          ...
          <div data-batch-reveal className="grid gap-5 md:grid-cols-3">
            {HOW_TO_STEPS.map((step, i) => (
              <div
                key={i}
                className="flex flex-col gap-4 rounded-[22px] border border-theme-border bg-theme-card p-6 shadow-card"
              >
                <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-theme-subtle">
                  {step.icon}
                </div>
                <div>
