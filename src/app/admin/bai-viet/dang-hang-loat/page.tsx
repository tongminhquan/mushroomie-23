  ...
  return (
    <div className="p-6 max-w-[1200px]">
      ...
      <div className="bg-[#fff7f2] border-[1.5px] border-[#ffd6d6] rounded-[14px] p-4 mb-6 text-sm text-neutral-700 space-y-1">
        ...
        <p>• SEO nâng cao: <code className="bg-white px-1 rounded">seo_title</code>, <code className="bg-white px-1 rounded">focus_keyword</code>, <code className="bg-white px-1 rounded">secondary_keywords</code>, <code className="bg-white px-1 rounded">canonical_url</code>, <code className="bg-white px-1 rounded">robots_index</code>, <code className="bg-white px-1 rounded">robots_follow</code>, <code className="bg-white px-1 rounded">featured_image_alt</code>.</p>
