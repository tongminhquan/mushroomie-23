  ...
  return (
    <div className="p-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
        ...
        <Link href="/admin/bai-viet/them" className="bg-primary text-white px-5 py-2.5 rounded-xl font-semibold text-sm hover:bg-primary-dark transition-colors whitespace-nowrap flex-1 text-center md:flex-none">
          + Thêm bài viết
        </Link>
      </div>
