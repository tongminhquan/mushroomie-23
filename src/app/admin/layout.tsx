  ...
  return (
    <SessionProvider session={session}>
      <ProfileCompletionGuard>
        <div className="admin-theme-scope flex h-[100dvh] overflow-hidden bg-theme-page text-theme-primary">
          <AdminSidebar />
          <main
            id="main-content"
            className="flex-1 overflow-auto bg-theme-page pt-16 md:pt-0"
          >
