    ...
    <main id="main-content" className="paper-surface grid min-h-[100dvh] place-items-center bg-theme-page p-4">
      <div className="grid w-full max-w-4xl overflow-hidden rounded-[18px] border border-theme-border bg-theme-card shadow-strong md:grid-cols-[0.8fr_1.2fr]">
        ...
        <div className="flex flex-col justify-center p-8 md:p-12">
          ...
          <p className="font-heading text-7xl leading-none text-theme-accent">404</p>
          <h1 className="mt-4 font-heading text-3xl leading-tight text-theme-primary">Trang này không còn ở đây</h1>
          <p className="mt-4 max-w-md text-sm leading-7 text-theme-secondary">
          ...
          <div className="mt-7 flex flex-wrap gap-3">
            ...
            <Link href="/san-pham" className="rounded-xl border border-primary px-6 py-3 text-sm font-extrabold text-theme-accent hover:bg-primary hover:text-white">Xem sản phẩm</Link>
          </div>
        </div>
      </div>
    </main>
