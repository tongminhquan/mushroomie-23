...
export default function MobileBottomNav() {
  ...
  return (
    <nav
      ...
      className="theme-transition fixed bottom-0 left-0 right-0 z-50 border-t border-theme bg-theme-page/90 px-3 pt-2.5 pb-[calc(0.625rem+env(safe-area-inset-bottom))] shadow-[var(--shadow-card-theme)] backdrop-blur-md md:hidden"
    >
